...
Page<Review> findByPost_Id(Long id, Pageable pageable); Page<Review> findByUser_Id(Long id, Pageable pageable); void deleteByUser(User user); void deleteByPost(Post post); }
